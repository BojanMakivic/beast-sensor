"""Velocity-based signal processing for Agile VBT repetitions."""
...
def decode_imu_packet(
    ...
    """Decode an Agile VBT packet into world-oriented acceleration.

    Agile VBT sends its world-to-body quaternion as x,y,w,z. Conjugating it yields
    ...
    def __init__(
        ...
        *,
        ...
        self._worker = threading.Thread(
            ...
            name="agile-vbt-recording-writer",
            daemon=False,
        )
        self._worker.start()
        self.write(
