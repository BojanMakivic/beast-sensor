...
from agile_vbt_dashboard_stream import DashboardBroker, PROTOCOL_VERSION
...
async def agile_vbt_live_socket(websocket: WebSocket) -> None:
                ...
                try:
                    if client is None:
                        ...
                        sender = asyncio.create_task(
                            ...
                            name=f"agile-vbt-dashboard-client-{client.identifier}",
                        )
                    else:
...
app = st.App(
    DASHBOARD_SCRIPT,
    lifespan=lifespan,
    routes=[WebSocketRoute("/api/agile-vbt/live", agile_vbt_live_socket)],
)
